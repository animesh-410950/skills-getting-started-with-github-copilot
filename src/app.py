...
activities.update({
    "Soccer Team": {
        "description": "Outdoor team soccer practice and matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "linda@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Indoor basketball training and friendly games",
    ...
    "Art Club": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["nora@mergington.edu", "maya@mergington.edu"]
    },
    "Drama Club": {
